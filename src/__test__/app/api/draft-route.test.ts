...
describe("Draft API Route", () => {
  ...
  it("should handle slug without locale prefix", async () => {
    const request = createMockRequest("http://localhost:3000/api/draft?slug=dev/prices");
  ...
  it("should extract locale from slug and remove it from path", async () => {
    const request = createMockRequest("http://localhost:3000/api/draft?slug=en/dev/prices");
  ...
  it("should handle slug with locale but no environment segment", async () => {
    const request = createMockRequest("http://localhost:3000/api/draft?slug=en/prices");
  ...
  it("should use locale parameter when slug doesn't contain locale", async () => {
    const request = createMockRequest("http://localhost:3000/api/draft?slug=dev/prices&locale=en");
  ...
  it("should handle invalid locale in slug", async () => {
    const request = createMockRequest("http://localhost:3000/api/draft?slug=fr/dev/prices");
