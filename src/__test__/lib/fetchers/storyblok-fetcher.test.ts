...
const mockGetStoryblokApi = getStoryblokApi as jest.MockedFunction<typeof getStoryblokApi>;
  ...
  describe("fetchSBData", () => {
    ...
    describe("caching configuration", () => {
      it("should set correct cache tags for different environments and languages", async () => {
        ...
        expect(mockGetStory).toHaveBeenCalledWith("stage/about-us", expect.any(Object), {
          next: {
            revalidate: 300,
      ...
      it("should set 5-minute revalidation time", async () => {
        ...
        expect(mockGetStory).toHaveBeenCalledWith(expect.any(String), expect.any(Object), {
          next: {
    ...
    describe("error handling", () => {
      it("should handle API errors gracefully", async () => {
        ...
        await expect(fetchSBData("dev", "test-story")).rejects.toThrow("Storyblok API error");
      });
    ...
    describe("route construction", () => {
      ...
      it("should handle empty slug", async () => {
        ...
        expect(mockGetStory).toHaveBeenCalledWith("dev/", expect.any(Object), expect.any(Object));
      });
    ...
    describe("draft mode edge cases", () => {
      it("should handle draft mode promise rejection", async () => {
        ...
        await expect(fetchSBData("dev", "test-story")).rejects.toThrow("Draft mode error");
      });
