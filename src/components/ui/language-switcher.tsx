...
const LanguageSwitcher = ({ className, indicatorClassName }: LanguageSwitcherProps) => {
  ...
  const orderedLanguages = [currentLanguage, ...languages.filter((l) => l !== currentLanguage)];
  ...
  return (
    <div ref={containerRef} className={cn("relative inline-flex", className)}>
      <Select
        ...
        onValueChange={(value) => handleLocaleChange(value.toLowerCase() as Locale)}
      >
